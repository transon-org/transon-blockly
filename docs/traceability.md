...
| Encoder output loads in Blockly | encoder output deserializes via Blockly's workspace loader without error (headless) | `SPEC.md` FR-126 | [x] full §15.8 corpus (147 examples + M1 corpus) encode→load: `test/engine-node-adapter/test/codec/blockly-load.test.ts` |

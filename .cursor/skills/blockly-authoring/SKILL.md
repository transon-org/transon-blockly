...
The full procedure is tool-neutral and lives in `harness/skills/blockly-authoring.md` — read and
follow it. Context7 is fine for the **Blockly/Zelos API only** — never for Transon semantics.

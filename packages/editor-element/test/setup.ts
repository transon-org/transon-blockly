// Vitest jsdom setup for editor-element. createTransonEditor mounts a rendered Blockly workspace, so
// stub the SVG/canvas/layout APIs jsdom lacks (same set as editor-ui's setup).
